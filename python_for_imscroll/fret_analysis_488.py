...
def main():
    ...
    sequence_order = [Channel(ex='blue', em='blue'),
                      Channel(ex='blue', em='green'),
                      Channel(ex='green', em='green')]
    image_sub_dirs = [path for path in image_dir.iterdir() if path.is_dir()]
